    ...
    return(
        ...
        <div>
            ...
            <div class="row  container-fluid  m-0 p-0">
                   <img className="img-fluid" src="./assets/img/Exterior_Banner_1.jpg" alt="strong hold"/>
                           ...
                           <div className="row h-100 d-flex  align-items-start">
                             ...
                             <div className="col-4 curved_interior"> 
                                  <div className=" def_ani wow animate__animated animate__fadeIn ">
                                    <h4 className="heading_interior text-black text_uppercase text-white mt-sm-5 ">VENCER GRIP STRONG HOLD</h4>
                                  </div>
                              </div>
                             <div className="col-4"></div>     
                           </div>
        ...
        <div class="container-lg">
            ...
            <div class="row">
                <div class="col-xs-4 col-md-4 mb-1 mb-md-4 mt-5 d-flex justify-content-center">
                    <img class="product_inner_img def_ani wow animate__animated animate__slideInLeft zoom_out"src="./assets/img/stronghold.png" alt="supershield"/>
                ...
                <div class="col-xs-12 col-md-8 py-5 d-flex flex-column justify-content-center">
                    ...
                    VENCER GRIP STRONG HOLD
                    </h3>
                   
                    <p class="text-white pt-2 py-md-5 pl-0 pl-md-3  text-center super_shield_p def_ani wow animate__animated animate__fadeIn">
 
                    JUMBO GRIP – STRONG HOLD  is a synthetic resin adhesive to be used for wood working.  JUMBO GRIP STRONG HOLD strongly binds wood, plywood, laminate, veneers, MDF and all types of boards and cork.
                    </p>
                </div>
            </div>
        </div>
                                ...
                                <table class="card-body table table-bordered" >
                                    ...
                                    <tbody class="">
                                        <tr class="">
                                            ...
                                            <td class="table_bord pl-1 pl-sm-3">VENCER SYNTHETIC WOOD ADHESIVE </td>
                                        </tr>
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Usage/Application</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">Wooden Works</td>
                                        </tr>
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Packaging Size</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">500 gm, 1 kg, 2 kg, 5 kg,10 kg, 20 kg, 50 kg</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Appearence</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">Free Flowing White Liquid</td>
                                        </tr>
              ...
              <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="row d-flex p-1 p-md-5 justify-content-center">
                    <div class="col-12 col-md-12 col-lg-11 p-2 p-md-5">
                        <h4 class="about_highlight_max text-left">Advantages:</h4>
                        <ul class="p-3 ul_list_square">
                            <li>
                                <p class="tech_spec pl-2 py-1">
                                JUMBO GRIP – SH  is a synthetic resin adhesive to be used for wood working.  JUMBO GRIP SH strongly binds wood, plywood, laminate, veneers, MDF and all types of boards and cork.
                                </p>
                            </li>
                        </ul>
