    ...
    return(
        ...
        <div>
            ...
            <div class="row  container-fluid  m-0 p-0">
                   ...
                   <img className="img-fluid" src="./assets/img/banner1.jpg" alt="Aqua Shine"/>
                           ...
                           <div className="row h-100 d-flex  align-items-start">
                             ...
                             <div className="col-4 curved_interior"> 
                                  <div className=" def_ani wow animate__animated animate__fadeIn ">
                                    <h4 className="heading_interior text-black text_uppercase text-white mt-sm-5 ">Vencer Paints AQUA SHINE</h4>
                                  </div>
                              </div>
                             <div className="col-4"></div>
        ...
        <div class="container-lg">
            ...
            <div class="row">
                <div class="col-xs-4 col-md-4 mb-2 mt-5 pt-4 d-flex justify-content-center">
                    <img class="product_inner_img def_ani wow animate__animated animate__slideInLeft zoom_out" src="./assets/img/aqua_shine.png" alt="AquaShine" />
                </div>
                <div class="col-xs-12 col-md-8 pt-4 pb-2 d-flex flex-column ">
                    <h3 class="text-white text_uppercase text-center super_shield_h3 px-5 pt-5 def_ani wow animate__animated animate__fadeInDown">WATER ENAMEL - AQUA SHINE
                    </h3>
                    <p class="text-white pt-3 pl-2  text-center super_shield_p def_ani wow animate__animated animate__fadeIn">
                     Aqua SHINE Semi Gloss Enamel Paint is a premium quality paint formulated to provide a smooth, semi glossy finish to Wall, wood &#38; metal surfaces. This is water thinnable enamel paint and formulated to provide excellent durable finish.
                    </p>
                    <p class="text-white pt-3 pl-2  text-center super_shield_p def_ani wow animate__animated animate__fadeIn">
                        Paint has features like low VOC, low odour and non-yellowing character when compared to conventional solvent based enamels.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <ul class="nav nav-pills mb-3 row d-flex justify-content-around" id="pills-tab" role="tablist">
                    <li class=" col-md-3 nav-item" role="presentation">
                        <a class="nav-link active text_uppercase text-center text_black custom_bg d-flex align-items-center justify-content-center  baseBlock_noHover def_ani wow animate__animated animate__fadeInDown"
                             id="pills-home-tab" data-toggle="pill"
                            href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Benefits</a>
                    </li>
                    <li class=" col-md-3 nav-item" role="presentation">
                        <a class="nav-link text_uppercase text-center text_black custom_bg d-flex align-items-center justify-content-center baseBlock_noHover def_ani wow animate__animated animate__fadeInDown"
                    ...
                    <li class=" col-md-3 nav-item" role="presentation">
                        <a class="nav-link text_uppercase text-center text_black text_black custom_bg d-flex align-items-center justify-content-center baseBlock_noHover def_ani wow animate__animated animate__fadeInDown"
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active " id="pills-home" role="tabpanel"
                        ...
                        <div class="row d-flex justify-content-md-between justify-content-center">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-4  mt-5 d-flex justify-content-center">
                                <div
                                    ...
                                    <img class="" src="" alt=""/>
                                    <p class="super_shield_p p-2">Low odour</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-4 mt-5 d-flex justify-content-center">
                                ...
                                class="custom_img_box  bg_soft_sheen d-flex flex-column align-items-center justify-content-center card-2">
                                    <img class="" src="" alt=""/>
                                    <p class="super_shield_p p-2">Excellent hiding levelling</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-4 mt-5 d-flex justify-content-center">
                                ...
                                class="custom_img_box  bg_exc_work d-flex flex-column align-items-center justify-content-center card-2">
                                    ...
                                    <p class="super_shield_p p-2 text-center">Semi gloss finish</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex  justify-content-md-center justify-content-center">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-4 mt-5 d-flex justify-content-center">
                                ...
                                class="custom_img_box  bg_soft_sheen d-flex flex-column align-items-center justify-content-center card-2">
                                    <img class="" src="" alt=""/>
                                    <p class="super_shield_p p-2 text-center">Water based enamel, quick drying</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-4 mt-5 d-flex justify-content-center">
                                ...
                                class="custom_img_box  bg_exc_work d-flex flex-column align-items-center justify-content-center card-2">
                                    ...
                                    <p class="super_shield_p p-2 text-center">Washable - easy cleaning</p>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-8 col-md-4 mt-5 mb-5 d-flex justify-content-center">
                                ...
                                class="custom_img_box  bg_soft_sheen d-flex flex-column align-items-center justify-content-center card-2">
                                    <img class="" src=""  alt=""/>
                                    <p class="super_shield_p p-2 text-center">No added lead, mercury &#38; chromium</p>
                                </div>
                            </div>
                                ...
                                <table class="card-body table table-bordered">
                                    ...
                                    <tbody>
                                        <tr class="">
                                            ...
                                            <td class=" table_bord pl-1 pl-sm-3">Semi Gloss</td>
                                        </tr>
                                        <tr class="">
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Brand</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3 text_uppercase">VENCER PAINTS</td>
                                        </tr>
                                      
                                        <tr class="">
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Packaging Size</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3"> 500ml, 1LTR, 4LTR, 10LTR &#38; 20LTR</td>
                                        </tr>
                                        
                                        <tr class="">
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Surface of Application</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">Wood, Metal, Wall</td>
                                        </tr>
                                        <tr class="">
                                        ...
                                        <tr class="">
                                            <td class=" table_bord pl-1 pl-sm-5"><strong>Paint Type</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">Enamel</td>
                                        </tr>
                                        <tr class="">
                                            <td class=" table_bord pl-1 pl-sm-5"><strong>Packing Type</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">Bucket</td>
                                        </tr>
                                       
                                        <tr class="">
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Coverage</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">120 square feet / Litre for 2 coats for Walls
                                                80-90 Square feet / Litre for Wood &#38; Metal</td>
                                        </tr>
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                        <div class="row d-flex p-2 p-md-5 justify-content-center">
                            <div class="col-12 col-md-12 col-lg-11 p-1 p-md-5">
