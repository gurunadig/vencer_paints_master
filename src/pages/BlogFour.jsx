    ...
    return(
        <div>
            ...
            <div class="row  container-fluid d-flex align-items-center justify-content-center m-0 p-0">
                   <img className="img-fluid w-100" src="./assets/img/blogimg_4.jpg" alt="Interior Ezy Wash"/>
                       <div className="fixbg_new">
                        ...
                        Green Colour Combination for Home Interiors
                        </h5>
            ...
            <div className="container-fluid px-2 px-sm-2 px-md-4 px-lg-5 py-4 bg_getintouch">
                <div className="row px-1 px-lg-4">
                    <div className="col-12 col-md-8 px-3">
                        <h3 className="py-3">Green Colour Combination for Home Interiors</h3>
                    <p>
                    Green, a secondary color, acts as a bridge between warm and cold colors. Green means balance and harmony and is often used to describe nature and hope. Not too much green has no downsides. Green supplies air energy and helps reduce stress. Green paint on the wall in your living room can reduce your stress and it's the perfect look when you return home from the office.
                    </p>
                    </div>
