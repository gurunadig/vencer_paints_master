    ...
    return(
        ...
        <div>
            ...
            <div class="row  container-fluid  m-0 p-0">
                   <img className="img-fluid" src="./assets/img/weather_guard.jpg" alt="exterior product Weather guard"/>
                           ...
                           <div className="row h-100 d-flex  align-items-start">
                             ...
                             <div className="col-4 curved_interior"> 
                                  <div className=" def_ani wow animate__animated animate__fadeIn ">
                                    <h4 className="heading_interior text-black text_uppercase text-white mt-sm-5 ">Vencer Paints Weather Guard</h4>
                                  </div>
                              </div>
                             <div className="col-4"></div>     
                           </div>
        ...
        <div class="container-lg">
            ...
            <div class="row">
                <div class="col-xs-4 col-md-4 mb-1 mb-md-4 mt-5 d-flex justify-content-center">
                    <img class="product_inner_img def_ani wow animate__animated animate__slideInLeft zoom_out" src="./assets/img/weather_guard.png" alt=""/>
                ...
                <div class="col-xs-12 col-md-8 pt-4 pb-2 d-flex flex-column justify-content-center">
                    <h3 class="text-white text_uppercase text-center super_shield_h3 px-5 def_ani wow animate__animated animate__fadeInDown">
                        vencer paints weather guard
                    </h3>
                    <p class="text-white pt-2 py-md-5 pl-0 pl-md-3 text-center super_shield_p def_ani wow animate__animated animate__fadeIn">
                        It is an Acrylic Emulsion and is a water based Exterior paint. It is economical and manufactured to suit dry or moderately humid climatic conditions.</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="row d-flex justify-content-md-between justify-content-center">
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-4 mt-5 d-flex justify-content-center">
                                ...
                                class="custom_img_box  bg_soft_sheen d-flex flex-column align-items-center justify-content-center card-2">
                                    <img class="" src=""  alt=""/>
                                    <p class="super_shield_p p-2">All Weather Emulsion</p>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-8 col-md-4 mt-5 d-flex justify-content-center">
                                ...
                                class="custom_img_box  bg_exc_work d-flex flex-column align-items-center justify-content-center card-2">
                                    <img class="" src=""  alt=""/>
                                    <p class="super_shield_p p-2">Water Resistant</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="card-body table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class=" table_bord pl-1 pl-sm-3">Smooth Sheen</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table_bord pl-1 pl-sm-3">50 square feet / Litre for 2 coats</td>
                                        </tr>
                                        <tr>
                                            <td class=" table_bord pl-1 pl-sm-5"><strong>Dry for Recoating</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">After a gap of 6 hours</td>
                                        </tr>
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Thinning</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">Mix 300 ml of clean potable water with 1 Litre of paint</td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="row d-flex p-1 p-md-5 justify-content-center">
                            <div class="col-12 col-md-12 col-lg-11 p-2 p-md-5">
                                ...
                                <ul class="p-3 ul_list_square">
                                    ...
                                    <li>
                                        <p class="tech_spec pl-2 py-1">To 1 litre of <strong>WEATHER GUARD</strong> add 300 ml of clean
