...
function Pab2404(){
    return(
        ...
        <div class="row  container-fluid  m-0 p-0">
                   <img className="img-fluid" src="./assets/img/exterior_banner_1.jpg" alt="PAB-2404 VENACRYL"/>
                           ...
                           <div className="row h-100 d-flex  align-items-start">
                             ...
                             <div className="col-4 curved_interior"> 
                                  <div className=" def_ani wow animate__animated animate__fadeIn ">
                                    <h4 className="heading_interior text-black text_uppercase text-white mt-sm-5 ">
                                    VENACRYL PAB - 2404
                                    </h4>
                                  </div>
                              </div>
        ...
        <div class="container-lg">
            ...
            <div class="row">
                <div class="col-xs-4 col-md-4 mb-1 mb-md-4 mt-5 d-flex justify-content-center">
                    <img class="product_inner_img def_ani wow animate__animated animate__slideInLeft zoom_out"src="./assets/img/pab_2404.png" alt="supershield"/>
                ...
                <div class="col-xs-12 col-md-8 py-5 d-flex flex-column justify-content-center">
                    ...
                    <p class="text-white text-center super_shield_p def_ani wow animate__animated animate__fadeIn">
                        Acrylic Emulsion is a 100% acrylic dispersion supplied at 50% solids.
                    </p>
                    <p class="text-white pt-2 py-md-5 pl-0 pl-md-3  text-center super_shield_p def_ani wow animate__animated animate__fadeIn">
                       The exterior durability of VENACRYL PAB-2404  in semi-gloss and gloss formulations has been tested over a variety of substrates, and no differences were observed after 12 months exterior exposure. The 100% acrylic back bone ensures the gloss retention, tint retention, dirt pick-up resistance and alkali resistance will be equivalent to the high standard associated with the type of product
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        ...
                        <h4 class="about_highlight_max d-flex justify-content-start align-items-start text-left ">Physical Properties: </h4>
                                ...
                                <table class="card-body table table-bordered" >
                                    ...
                                    <tbody class="">
                                        ...
                                        <tr>
                                            ...
                                            <td class="table_bord pl-1 pl-sm-3">49.5 - 50.5%</td>
                                        </tr>
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>pH When Packed</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3"> 8.5 - 9.1</td>
                                        </tr>
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Viscosity Brookfield (mPa.s),LV,Spindle #2,60 rpm, 25 &#176; Celsius</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">50-300 mPa.s</td>
                                        </tr>
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Minimum Film Formation Temperature</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3"> &#126; 18 &#176;C &#177;1</td>
                                        </tr>
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Specific Gravity (Wet Ploymer)</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">1.07/gm&#179; &#177; 0.02 </td>
                                        </tr>
                                        <tr>
                                            <td class="table_bord pl-1 pl-sm-5"><strong>Specific Gravity (Dry Ploymer)</strong></td>
                                            <td class="table_bord pl-1 pl-sm-3">1.13/gm&#179; &#177; 0.02 </td>
                                        </tr>
                            ...
                            <div class="col-12 col-md-12 pt-5 col-lg-11 pl-2 pl-md-5">
                                <h4 class="about_highlight_max text-left">Additional Properties :</h4>
                                <ul class="p-3">
                                    <li>
                                        <p class="tech_spec pl-2">In addition, the proprietary adhesion technology incorporated in this dispersion will offer a high degree of crack resistance and facilitate adhesion to wood and alkyd repaint surfaces in wet and dry conditions.</p>
                                    </li>
              ...
              <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="row d-flex p-1 p-md-5 justify-content-center">
                    <div class="col-12 col-md-12 col-lg-11 p-2 p-md-5">
                        ...
                        <p class="tech_spec pl-2 py-1">VENACRYL PAB-2404 Acrylic Emulsion is also a very suitable polymer for the formulation of interior semi-gloss paints, again demonstrating excellent adhesion and blister resistance in wet conditions (kitchens and bathrooms), plus excellent stain and scrub resistance. The acrylic composition ensures a high level of resistance to detergents and alkali cleaning agents
                        </p>
                        <p class="tech_spec pl-2 py-1">
                            VENACRYL PAB-2404 Acrylic Emulsion is also a suitable binder for formulating floor paints, tennis court paints, concrete and fiber cement roof tile paints and other coatings where good exterior durability is needed.
                        </p>
                    </div>
                </div>
            </div>
